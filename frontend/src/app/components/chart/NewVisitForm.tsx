...
export function NewVisitForm({ onSave, onCancel }: { onSave: (visit: Visit) => void; onCancel: () => void }) {
  ...
  return (
    <div className="border-2 border-primary mb-4">
      <div className="flex items-center justify-between px-4 py-2.5 bg-primary text-primary-foreground">
        ...
        <button onClick={onCancel}><X className="w-4 h-4 opacity-70 hover:opacity-100" /></button>
      </div>
      <div className="p-4 space-y-4">
        ...
        <div className="flex justify-end gap-2 pt-1 border-t border-border">
          <button onClick={onCancel} className="text-[13px] px-4 py-1.5 border border-border rounded hover:bg-muted">취소</button>
